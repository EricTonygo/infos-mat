...
>>>>>>> master
			 ...
			 *
			 *  @type string
			 *  @default Vu de _START_ à _END_ sur _TOTAL_ entrées
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "info": "Vu de _PAGE_ sur _PAGES_"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfo": "Vu de _START_ à _END_ sur _TOTAL_ entrées",
			 ...
			 *  @type string
			 *  @default Vu de 0 à 0 sur 0 entrées
			 *
			 *  @dtopt Language
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoEmpty": "Aucune entrée à visualiser"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfoEmpty": "Vu de 0 à 0 sur 0 entrées",
