...
class ReglageType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('typereglage','entity', array(
                'class' => 'NNGenieMaintenanceBundle:Typereglage',
                'property' => 'nom',
                'empty_value' => "",
                'multiple'=>false,
                'query_builder' => function(\NNGenie\MaintenanceBundle\Repository\TypereglageRepository $repo) {
                    return $repo->getTypereglageQueryBuilder();
                }
            ))
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'NNGenie\MaintenanceBundle\Entity\Reglage'
        ));
    }
}
