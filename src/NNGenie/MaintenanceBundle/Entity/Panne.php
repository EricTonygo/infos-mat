...
class Panne extends \NNGenie\MaintenanceBundle\Entity\Maintenancecorrective {
     ...
     *
     * @ORM\ManyToMany(targetEntity="Piece", inversedBy="pannes", cascade={"persist"})
     * 
     */
    private $pieces;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="Operation", inversedBy="pannes", cascade={"persist"})
     * 
     */
    private $operations;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="Test", inversedBy="pannes", cascade={"persist"})
     * 
     */
    private $tests;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\ManyToMany(targetEntity="Question", inversedBy="pannes", cascade={"persist"})
     * 
     */
    private $questions;
